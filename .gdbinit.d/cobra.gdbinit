...
alias sna = x/33fg
# segment booleand array
alias sba = x/33b

alias win = x/200b bzf_win1_corr.data_
alias winn = x/200b bzf_win2_corr.data_
alias sr = x/200b bzb_sel_rad.data_
alias scd = x/200fg bzd_scd_tmp.data_
alias segscd = x/33fg bzd_scd_segment.data_

#break Cobra.cpp:breakpoint(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >)
